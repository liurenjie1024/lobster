...
class ReachableQuery extends com.sun.tools.hat2.internal.server.QueryHandler {
    ...
    public void run() {
        ...
        com.sun.tools.hat2.internal.model.ReachableObjects ro = new com.sun.tools.hat2.internal.model.ReachableObjects(root,
                                   snapshot.getReachableExcludes());
        // Now, print out the sorted list, but start with root
        long totalSize = ro.getTotalSize();
        com.sun.tools.hat2.internal.model.JavaThing[] things = ro.getReachables();
