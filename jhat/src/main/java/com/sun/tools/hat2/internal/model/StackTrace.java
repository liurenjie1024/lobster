...
public class StackTrace {
    ...
    private com.sun.tools.hat2.internal.model.StackFrame[] frames;

    public StackTrace(com.sun.tools.hat2.internal.model.StackFrame[] frames) {
        this.frames = frames;
    }
    ...
    public StackTrace traceForDepth(int depth) {
        if (depth >= frames.length) {
            ...
            com.sun.tools.hat2.internal.model.StackFrame[] f = new com.sun.tools.hat2.internal.model.StackFrame[depth];
