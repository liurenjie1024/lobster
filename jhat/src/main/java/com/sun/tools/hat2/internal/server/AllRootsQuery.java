...
import com.sun.tools.hat2.internal.model.Root;
...
class AllRootsQuery extends com.sun.tools.hat2.internal.server.QueryHandler {
    ...
    public void run() {
        ...
        ArraySorter.sort(roots, new Comparer() {
            public int compare(Object lhs, Object rhs) {
                com.sun.tools.hat2.internal.model.Root left = (com.sun.tools.hat2.internal.model.Root) lhs;
                com.sun.tools.hat2.internal.model.Root right = (com.sun.tools.hat2.internal.model.Root) rhs;
        ...
        for (int i= 0; i < roots.length; i++) {
            com.sun.tools.hat2.internal.model.Root root = roots[i];
            ...
            com.sun.tools.hat2.internal.model.JavaThing t = snapshot.findThing(root.getId());
