...
package com.sun.tools.hat2.internal.oql;
...
public class OQLEngine {
    ...
    */
    public synchronized void executeQuery(String query, com.sun.tools.hat2.internal.oql.ObjectVisitor visitor)
                                          throws com.sun.tools.hat2.internal.oql.OQLException {
        ...
        if (st.hasMoreTokens()) {
            ...
            if (! first.equals("select") ) {
                ...
                try {
                    ...
                    throw new com.sun.tools.hat2.internal.oql.OQLException(e);
                }
                return;
            }
        } else {
            throw new com.sun.tools.hat2.internal.oql.OQLException("query syntax error: no 'select' clause");
        }
        ...
        if (selectExpr.equals("")) {
            throw new com.sun.tools.hat2.internal.oql.OQLException("query syntax error: 'select' expression can not be empty");
        }
        ...
        if (seenFrom) {
            if (st.hasMoreTokens()) {
                ...
                if (tmp.equals("instanceof")) {
                    isInstanceOf = true;
                    if (! st.hasMoreTokens()) {
                        throw new com.sun.tools.hat2.internal.oql.OQLException("no class name after 'instanceof'");
                    }
                ...
                throw new com.sun.tools.hat2.internal.oql.OQLException("query syntax error: class name must follow 'from'");
            }

            if (st.hasMoreTokens()) {
                identifier = st.nextToken();
                if (identifier.equals("where")) {
                    throw new com.sun.tools.hat2.internal.oql.OQLException("query syntax error: identifier should follow class name");
                }
                if (st.hasMoreTokens()) {
                    String tmp = st.nextToken();
                    if (! tmp.equals("where")) {
                        throw new com.sun.tools.hat2.internal.oql.OQLException("query syntax error: 'where' clause expected after 'from' clause");
                    }
                    ...
                    if (whereExpr.equals("")) {
                        throw new com.sun.tools.hat2.internal.oql.OQLException("query syntax error: 'where' clause cannot have empty expression");
                    }
                }
            } else {
                throw new com.sun.tools.hat2.internal.oql.OQLException("query syntax error: identifier should follow class name");
        ...
        executeQuery(new com.sun.tools.hat2.internal.oql.OQLQuery(selectExpr, isInstanceOf, className,
                                  identifier, whereExpr), visitor);
    }

    private void executeQuery(com.sun.tools.hat2.internal.oql.OQLQuery q, ObjectVisitor visitor)
                              throws com.sun.tools.hat2.internal.oql.OQLException {
        com.sun.tools.hat2.internal.model.JavaClass clazz = null;
        if (q.className != null) {
            clazz = snapshot.findClass(q.className);
            if (clazz == null) {
                throw new com.sun.tools.hat2.internal.oql.OQLException(q.className + " is not found!");
            }
        }
            ...
            if (q.className != null) {
                ...
                while (objects.hasMoreElements()) {
                    com.sun.tools.hat2.internal.model.JavaHeapObject
                        obj = (com.sun.tools.hat2.internal.model.JavaHeapObject) objects.nextElement();
    ...
    public Object wrapJavaObject(com.sun.tools.hat2.internal.model.JavaHeapObject obj) throws Exception {
    ...
    private void init(com.sun.tools.hat2.internal.model.Snapshot snapshot) throws RuntimeException {
