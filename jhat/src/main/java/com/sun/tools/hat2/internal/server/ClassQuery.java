...
import com.sun.tools.hat2.internal.model.JavaHeapObject;
...
class ClassQuery extends com.sun.tools.hat2.internal.server.QueryHandler {
    ...
    protected void printFullClass(com.sun.tools.hat2.internal.model.JavaClass clazz) {
        out.print("<h1>");
        ...
        com.sun.tools.hat2.internal.model.JavaClass[] sc = clazz.getSubclasses();
        ...
        com.sun.tools.hat2.internal.model.JavaField[] ff = clazz.getFields().clone();
        ArraySorter.sort(ff, new Comparer() {
            public int compare(Object lhs, Object rhs) {
                com.sun.tools.hat2.internal.model.JavaField left = (com.sun.tools.hat2.internal.model.JavaField) lhs;
                com.sun.tools.hat2.internal.model.JavaField right = (com.sun.tools.hat2.internal.model.JavaField) rhs;
        ...
        com.sun.tools.hat2.internal.model.JavaStatic[] ss = clazz.getStatics();
    ...
    protected void printReferencesTo(JavaHeapObject obj) {
        ...
        while (referers.hasMoreElements()) {
            com.sun.tools.hat2.internal.model.JavaHeapObject ref = (com.sun.tools.hat2.internal.model.JavaHeapObject) referers.nextElement();
            printThing(ref);
