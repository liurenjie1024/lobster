...
public class ReachableObjects {
    public ReachableObjects(com.sun.tools.hat2.internal.model.JavaHeapObject root,
                            final ReachableExcludes excludes) {
        this.root = root;

        final Hashtable<com.sun.tools.hat2.internal.model.JavaHeapObject, com.sun.tools.hat2.internal.model.JavaHeapObject> bag = new Hashtable<com.sun.tools.hat2.internal.model.JavaHeapObject, com.sun.tools.hat2.internal.model.JavaHeapObject>();
        ...
        JavaHeapObjectVisitor visitor = new AbstractJavaHeapObjectVisitor() {
            public void visit(com.sun.tools.hat2.internal.model.JavaHeapObject t) {
        ...
        com.sun.tools.hat2.internal.model.JavaThing[] things = new com.sun.tools.hat2.internal.model.JavaThing[bag.size()];
        int i = 0;
        for (Enumeration e = bag.elements(); e.hasMoreElements(); ) {
            things[i++] = (com.sun.tools.hat2.internal.model.JavaThing) e.nextElement();
        }
        ArraySorter.sort(things, new Comparer() {
            public int compare(Object lhs, Object rhs) {
                com.sun.tools.hat2.internal.model.JavaThing left = (com.sun.tools.hat2.internal.model.JavaThing) lhs;
                com.sun.tools.hat2.internal.model.JavaThing right = (com.sun.tools.hat2.internal.model.JavaThing) rhs;
    ...
    public com.sun.tools.hat2.internal.model.JavaHeapObject getRoot() {
        return root;
    }

    public com.sun.tools.hat2.internal.model.JavaThing[] getReachables() {
        return reachables;
    }
