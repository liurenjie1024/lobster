...
import com.sun.tools.hat2.internal.oql.ObjectVisitor;
...
class OQLQuery extends com.sun.tools.hat2.internal.server.QueryHandler {

    public OQLQuery(com.sun.tools.hat2.internal.oql.OQLEngine engine) {
        this.engine = engine;
    }
    ...
    private void executeQuery(String q) {
        try {
            ...
            out.println("</table>");
        } catch (com.sun.tools.hat2.internal.oql.OQLException exp) {
            printException(exp);
        }
    }

    private com.sun.tools.hat2.internal.oql.OQLEngine engine;
}
