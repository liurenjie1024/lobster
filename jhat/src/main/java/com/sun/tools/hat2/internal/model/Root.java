...
public class Root {
    ...
    private com.sun.tools.hat2.internal.model.JavaHeapObject referer = null;
    private com.sun.tools.hat2.internal.model.StackTrace stackTrace = null;
    ...
    public Root(long id, long refererId, int type, String description,
                com.sun.tools.hat2.internal.model.StackTrace stackTrace) {
        this.id = id;
