...
class InstancesCountQuery extends com.sun.tools.hat2.internal.server.QueryHandler {
    ...
    public void run() {
        ...
        com.sun.tools.hat2.internal.model.JavaClass[] classes = snapshot.getClassesArray();
        if (excludePlatform) {
            int num = 0;
            ...
            com.sun.tools.hat2.internal.model.JavaClass[] tmp = new com.sun.tools.hat2.internal.model.JavaClass[num];
        ...
        ArraySorter.sort(classes, new Comparer() {
            public int compare(Object lhso, Object rhso) {
                com.sun.tools.hat2.internal.model.JavaClass lhs = (com.sun.tools.hat2.internal.model.JavaClass) lhso;
                JavaClass rhs = (com.sun.tools.hat2.internal.model.JavaClass) rhso;
