...
package com.sun.tools.hat2.internal.util;
import java.util.*;
...
public class VectorSorter {
    ...
    **/
    static public void sort(Vector<Object> v, com.sun.tools.hat2.internal.util.Comparer c)  {
    ...
    **/
    static public void sortVectorOfStrings(Vector<Object> v) {
        sort(v, new com.sun.tools.hat2.internal.util.Comparer() {
            public int compare(Object lhs, Object rhs) {
                return ((String) lhs).compareTo((String) rhs);
            }
        });
