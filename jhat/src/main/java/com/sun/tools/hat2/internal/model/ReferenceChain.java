...
public class ReferenceChain {
    ...
    com.sun.tools.hat2.internal.model.JavaHeapObject obj;    // Object referred to
    ReferenceChain      next;   // Next in chain

    public ReferenceChain(com.sun.tools.hat2.internal.model.JavaHeapObject obj, ReferenceChain next) {
        this.obj = obj;
        this.next = next;
    }
