...
public abstract class JavaLazyReadObject extends JavaHeapObject {
    ...
    public final long getId() {
        try {
            ...
            if (idSize == 4) {
                return ((long)buf.getInt(offset)) & com.sun.tools.hat2.internal.model.Snapshot.SMALL_ID_MASK;
            } else {
    ...
    protected static Number makeId(long id) {
        if ((id & ~com.sun.tools.hat2.internal.model.Snapshot.SMALL_ID_MASK) == 0) {
    ...
    protected static long getIdValue(Number num) {
        ...
        if (num instanceof Integer) {
            id &= com.sun.tools.hat2.internal.model.Snapshot.SMALL_ID_MASK;
        }
        return id;
    }
