...
public class FinalizerSummaryQuery extends com.sun.tools.hat2.internal.server.QueryHandler {
    public void run() {
    ...
    private static class HistogramElement {
        public HistogramElement(com.sun.tools.hat2.internal.model.JavaClass clazz) {
            this.clazz = clazz;
        }
        ...
        private com.sun.tools.hat2.internal.model.JavaClass clazz;
        private long count;
    }

    private void printFinalizerSummary(Enumeration objs) {
        int count = 0;
        Map<com.sun.tools.hat2.internal.model.JavaClass, HistogramElement> map = new HashMap<com.sun.tools.hat2.internal.model.JavaClass, HistogramElement>();

        while (objs.hasMoreElements()) {
            com.sun.tools.hat2.internal.model.JavaHeapObject obj = (JavaHeapObject) objs.nextElement();
            count++;
            com.sun.tools.hat2.internal.model.JavaClass clazz = obj.getClazz();
